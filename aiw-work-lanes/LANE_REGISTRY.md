...
Registry status: `CANDIDATE / NOT YET INSTALLED`
...
| `TEST_BRAIN_ARCHIVE_ALIGNMENT` | Prove exact aligned AutoSheets Archive retrieval | `ACTIVE / PHONE PROOF REQUIRED` | Yes | `MAIN_LOCKED_CORE` |
| `TEST_BRAIN_CONTEXT_INTEGRATION` | Integrate Brain rules and bounded sender history into the production prompt | `BLOCKED BY ALIGNMENT` | Yes | `MAIN_LOCKED_CORE` |
